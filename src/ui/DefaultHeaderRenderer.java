...
public class DefaultHeaderRenderer extends DefaultTableCellRenderer {
	...
	/**
	 * Configures the renderer appropriately before drawing. After
	 * configuration, <code>this</code> component is returned and used by
	 * <code>JTable</code> to draw the cell header.
	 * 
	 * @param table
	 *            The <code>JTable</code> that is asking the renderer to draw;
	 *            can be <code>null</code>.
	 * @param value
	 *            The value of the cell header to be rendered.
	 * @param isSelected
	 *            True if the cell header is to be rendered with the selection
	 *            highlighted; otherwise false. Is not used in this
	 *            implementation
	 * @param hasFocus
	 *            If true, render cell appropriately. Is not used in this
	 *            implementation
	 * @param row
